  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'display-md': ['clamp(1.9rem, 4vw, 3rem)', { lineHeight: '1.1', letterSpacing: '-0.02em' }],
        'display-sm': ['clamp(1.6rem, 3vw, 2.25rem)', { lineHeight: '1.15', letterSpacing: '-0.015em' }],
        'heading-lg': ['clamp(1.4rem, 2vw, 1.75rem)', { lineHeight: '1.2', letterSpacing: '-0.01em' }],
        'heading-md': ['1.25rem', { lineHeight: '1.3', letterSpacing: '-0.005em' }],
        'body-lg': ['1.0625rem', { lineHeight: '1.65' }],
        'body': ['1rem', { lineHeight: '1.6' }],
        'body-sm': ['0.875rem', { lineHeight: '1.55' }],
        'mono': ['0.875rem', { lineHeight: '1.5', letterSpacing: '0.02em' }],
      },
      spacing: {
        '4.5': '1.125rem',
        '5.5': '1.375rem',
      ...
      boxShadow: {
        'paper': '0 1px 2px rgba(26, 24, 20, 0.04), 0 1px 1px rgba(26, 24, 20, 0.03)',
        'paper-lg': '0 4px 16px rgba(26, 24, 20, 0.06)',
